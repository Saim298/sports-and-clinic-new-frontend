...
const stripePromise = loadStripe(
  "pk_live_PmMTJX9qblSQ4kO2hdWHKkbE"
);
...
const EnterEvent = () => {
  ...
  const handleModalSubmit = async (paymentMethod) => {
    try {
      ...
      await axios.post(
        "https://www.gotnextcamps.com/api/event/registration/event/registrations",
        registrationData
      );

      if (paymentMethod === "stripe") {
        const response = await axios.post(
          "https://www.gotnextcamps.com/api/event/registration/payment/register",
          {
            userId: user_id,
            eventId: event_id,
