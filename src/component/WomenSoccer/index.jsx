    ...
    const fetchInitialData = async () => {
      try {
        ...
        const subscriptionResponse = await axios.post(
          "https://www.gotnextcamps.com/api/subscriptions/check-subscription",
          { userId }
        );
        ...
        if (subscriptionResponse.status === 200) {
          ...
          if (subscription.plan.exportBookmarks) {
            ...
            const bookmarkResponse = await axios.get(
              `https://www.gotnextcamps.com/api/event/registration/creation/bookmarked-events/${userId}`
            );
  ...
  const handleBookmark = async () => {
    try {
      ...
      const response = await axios.post(
        "https://www.gotnextcamps.com/api/event/registration/creation/bookmark",
        { userId, event_id }
      );
