...
const UserPlans = () => {
  ...
  const fetchPlans = async () => {
    try {
      const response = await axios.get("https://www.gotnextcamps.com/api/plan/plans");
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post("https://www.gotnextcamps.com/api/plan/plans", newPlan);
      setNewPlan({
        title: "",
        price: { monthly: "", yearly: "" },
        duration: "monthly",
  ...
  const handleEditSubmit = async (id) => {
    try {
      await axios.put(`https://www.gotnextcamps.com/api/plan/plans/${id}`, editPlan);
      setEditPlan(null);
      fetchPlans();
    } catch (error) {
