...
const AllFaqs = () => {
  ...
  const fetchFaqs = async () => {
    try {
      const response = await axios.get("https://www.gotnextcamps.com/api/admin-add-faqs/faqs");
  ...
  const handleDeleteFaq = async (id) => {
    try {
      await axios.delete(`https://www.gotnextcamps.com/api/admin-add-faqs/faq/${id}`);
  ...
  const handleUpdateFaq = async () => {
    try {
      await axios.put(`https://www.gotnextcamps.com/api/admin-add-faqs/faq/${editFaq._id}`, {
