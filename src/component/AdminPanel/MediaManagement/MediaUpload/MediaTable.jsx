...
const MediaTable = ({ mediaList, isLoading }) => {
  ...
  const handleDelete = async (id) => {
    if (window.confirm("Are you sure you want to delete this media?")) {
      try {
        await axios.delete(`https://www.gotnextcamps.com/api/admin-add-media/media/${id}`);
  ...
  const handleUpdateSubmit = async (e) => {
    ...
    try {
      await axios.put(`https://www.gotnextcamps.com/api/admin-add-media/media/${selectedMedia}`, data);
