...
const MediaUpload = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post("https://www.gotnextcamps.com/api/admin-add-media/media", data);
  ...
  const fetchMediaList = async () => {
    setIsLoading(true);
    try {
      const response = await axios.get("https://www.gotnextcamps.com/api/admin-add-media/media");
