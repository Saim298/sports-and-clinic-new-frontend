...
const BlogsList = () => {
  ...
  const fetchBlogs = async () => {
    try {
      const response = await axios.get(
        "https://www.gotnextcamps.com/api/admin-add-blog/blogs"
      );
  ...
  const handleEdit = async (id) => {
    ...
    try {
      const response = await axios.get(
        `https://www.gotnextcamps.com/api/admin-add-blog/blogs/${id}`
      );
  ...
  const handleSave = async (e) => {
    ...
    try {
      await axios.put(
        `https://www.gotnextcamps.com/api/admin-add-blog/blogs/${_id}`,
        formData,
        {
          headers: {
