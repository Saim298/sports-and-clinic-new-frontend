...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        const response = await axios.get('https://www.gotnextcamps.com/api/auth/users');
    ...
    const fetchEventData = async () => {
      try {
        const response = await axios.get('https://www.gotnextcamps.com/api/event/registration/creation/events');
